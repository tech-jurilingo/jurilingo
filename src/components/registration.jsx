          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 pr-10 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#005F63] focus:border-transparent transition-all"
                required
              />
              <button
                type="button"
